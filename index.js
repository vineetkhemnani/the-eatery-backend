...
app.get('/restaurant/menu', async (req, res) => {
  ...
  // Process the restaurant ID as needed
  console.log('Received restaurant ID:', restaurantId)

  // Send a response (you can customize this based on your needs)
//   res.json({ message: 'Restaurant ID received successfully', restaurantId })
const url = `https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=27.2074205&lng=78.01525769999999&restaurantId=${restaurantId}`
// console.log(url)
await fetch(url, {
  headers: {
    'Content-Type': 'application/json',
